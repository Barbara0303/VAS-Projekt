...
class Igrac(Agent):
    ...
    async def setup(self):
        ...
        fsm.add_transition(source="Odigraj", dest="Odigraj")
...
class Belot:
    def __init__(self, agenti):
        ...
        self.tim2_bodovi = 0
        self.adut = None
        self.prvi_agent_za_biranje_aduta = 0
            ...
            for broj in brojevi:
                ...
                if karta in nove_karte:
                    ...
                    if niz == 3:
                        ...
                        najjace_zvanje = max(najjace_zvanje, 501)
                    niz = 0
    ...
    def provjeri_pobjednika(self):
        if self.tim1_bodovi >= 201 and self.tim1_bodovi > self.tim2_bodovi:
            return 1
        elif self.tim2_bodovi >= 201:
            return 2
        else:
            return None
    ...
    def igraj(self):
        ...
        while(not kraj):
            ...
            print(f"TKO JE ZVAO: igrac {igrac}")
            ...
            if igrac_zvao_adut == 0 or igrac_zvao_adut == 2:
                if bodovi_1 < bodovi_za_prolaz:
                    bodovi_2 += bodovi_1 + self.bodovi_zvanja_tim1
                    bodovi_1 = 0
                    self.bodovi_zvanja_tim2 = self.bodovi_zvanja_tim1
                    self.bodovi_zvanja_tim1 = 0
            if igrac_zvao_adut == 1 or igrac_zvao_adut == 3:
                if bodovi_2 < bodovi_za_prolaz:
                    bodovi_1 += bodovi_2 + self.bodovi_zvanja_tim2
                    bodovi_2 = 0

            self.dodaj_bodove(1, bodovi_1)
            self.dodaj_bodove(2, bodovi_2)
